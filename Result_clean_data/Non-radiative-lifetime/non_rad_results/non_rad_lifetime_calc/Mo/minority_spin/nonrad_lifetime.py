...
# 3A2 - 3E
dQ = 5.04901 # dQ 3E <-> 3A2 in amu^1/2 . Ang
weff_i = 17.125441014641346 # omega_eff 3E in meV
weff_f = 16.609131582307704 # omega_eff 3A2 in meV
temp = 300.4693366708385156 # temperature in K

# Test different ZPL and calculate the lifetime:
ZPL_list = [1.56144] # ZPL values in eV
...
np.savetxt('lifetime_data.txt', np.array([ZPL_list, lifetime_list]).T)
np.savetxt('xif.txt', np.array([ZPL_list, xif_list]).T)
