...
# 3A2 - 3E
dQ = 1.79675375 # dQ 3E <-> 3A2 in amu^1/2 . Ang
weff_i = 34.31993705454413 # omega_eff 3E in meV
weff_f = 39.64085507377251 # omega_eff 3A2 in meV
temp = 300.4693366708385156 # temperature in K

# Test different ZPL and calculate the lifetime:
ZPL_list = [1.0746] # ZPL values in eV
