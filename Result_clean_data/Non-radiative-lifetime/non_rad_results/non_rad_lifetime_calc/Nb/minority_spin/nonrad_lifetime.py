...
# 3A2 - 3E
dQ = 3.83629 # dQ 3E <-> 3A2 in amu^1/2 . Ang
weff_i = 20.290425079508747 # omega_eff 3E in meV
weff_f = 20.26498284990815 # omega_eff 3A2 in meV
temp = 300.4693366708385156 # temperature in K

# Test different ZPL and calculate the lifetime:
ZPL_list = [1.7229] # ZPL values in eV
